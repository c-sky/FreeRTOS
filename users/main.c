...
int main (void)
{
    ...
    xTaskCreate( ShellTask, ( portCHAR * ) "Shell", configMINIMAL_STACK_SIZE*2, NULL, tskIDLE_PRIORITY+1, NULL );
    ...
    xTaskCreate( backTask,  ( portCHAR * ) "back",  configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY+4, NULL );
