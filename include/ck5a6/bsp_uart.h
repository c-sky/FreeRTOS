...
#ifndef __FREERTOS_UART_H
#define __FREERTOS_UART_H
...
#define __UART                        volatile uint32_t *
#define UART                         ((__UART)(0x10015000))
